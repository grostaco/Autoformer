...
class FixedEmbedding(nn.Module):
    """Non-learnable embedding module using positional encoding as weight
    ...
    def __init__(self, c_in: int, d_model: int):
        ...
        # The computation is done in log space to avoid numerical instability
        # If expanded, it is equivalent to normal positional encoding
        ...
        # Non-learnable (hence fixed) embedding using the positional encoding
        # as weight
...
class TokenEmbedding(nn.Module):
    """An embedding that generates cross-correlation between each timestep

    Args:
        c_in (int): The number of time steps
        d_model (int): Number of convolutions generated by the embedding
